...
public class PrintMedia extends CollectibleCollection{
    ...
    public PrintMedia(String itemName, double price, String itemCondition, String collectibeCategory, String author, String illustrator, String publisher, int pageCount) {
